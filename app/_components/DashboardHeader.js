  ...
  return (
    <div className="flex items-center justify-between gap-[16px] bg-[#FFFFFF] h-[64px] py-[12px] px-[32px] border border-b sticky top-0 z-50">
      <div className="flex items-center gap-[16px] h-[22px] w-[360px]">
        ...
        <div className="flex items-center gap-[6px] h-[16px] w-[94px]">
          ...
          <p className="text-[12px] text-bold-400 leading-[16px]">
            How it works
          </p>
        </div>
      </div>
      <div className="flex  items-center  gap-[8px] w-[400px] h-[40px] border border-none rounded-[6px] px-[16px] py-[9px] bg-[#F2F2F2]">
      ...
      <div className="flex gap-[8px] items-center justify-end w-[360px] h-[40px]">
        <div className="flex items-center gap-[12px] w-[92px] h-[40px]">
          <div className="flex items-center justify-center h-[40px] w-[40px] rounded-full bg-[#4D4D4D] bg-opacity-30 ">
            <div className="">
              <svg
                width="20"
                height="20"
